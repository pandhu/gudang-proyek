    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="am-active"><a href="<?php echo Yii::app()->baseUrl?>/admin">Beranda</a></li>
            <li><a href="<?php echo Yii::app()->baseUrl?>/admin/profile">Profil</a></li>
            <li><a href="<?php echo Yii::app()->baseUrl?>/admin/moderatorlist">Moderator</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?php echo Yii::app()->baseUrl?>/admin/edit">Pengaturan akun</a></li>
                <li><a href="<?php echo Yii::app()->baseUrl?>/admin/logout">Keluar</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
